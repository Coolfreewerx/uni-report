...
@section('content')
    <article class="mx-8">
        ...
        <p>
            <a class="text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded"
        ...
        <div> 
            ...
            <p class="bg-green-100 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded my-10">
        ...
        <p class="">
            <label class="block mb-2 text-sm font-bold text-green-400 dark:text-black-700">
        ...
        <p class="">
            <label class="block mb-2 text-sm font-bold text-green-400 dark:text-black-300 mt-4">
